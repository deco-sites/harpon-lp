...
import { ProductSearch } from "deco-sites/harpon-lp/islands/ProductSearch.tsx";
...
/*     const {selectedCategories, setSelectedCategories} = useContext(ProductContext) */
    ...
    return (
      ...
      <div class='xs:overflow-x-hidden 1xs:overflow-x-hidden md:overflow-x-hidden lg:overflow-x-hidden'>
        <h1 class='hidden text-[36px] font-normal ml-[139px] mt-[100px] xs:text-2xl xs:ml-[10px] xs:mt-[30px] 1xs:ml-[10px] 1xs:mt-[30px] 1xs:text-3xl sm:ml-5 md:ml-5 md:mt-[50px] lg:ml-5'>TODOS OS {' '} 
        ...
        <p class='text-[#29323A] '>{/* &#62;  */}Todos os produtos</p>
          ...
          <h2 class='hidden text-[24px] font-bold ml-[139px] mt-[100px] xs:ml-[10px] xs:mt-5 xs:text-xl 1xs:ml-[10px] 1xs:mt-5 1xs:text-xl sm:ml-5 md:ml-5 lg:ml-5'>
            ETAPAS
          </h2>
          ...
          <ProductSearch />
            <p class='hidden font-bold text-[#29323A] ml-[120px] xs:text-xs xs:ml-[-180px] xs:mt-[-60px] xs:w-min 1xs:mt-[-60px] 1xs:w-min 1xs:text-sm 1xs:ml-[-220px] sm:whitespace-nowrap sm:ml-5 md:ml-[15px] lg:ml-[10px] 2xl:ml-[400px]'>Ordenar por:</p>
