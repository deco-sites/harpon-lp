...
function CartButton({ loading, currency, total, items }: Props) {
  ...
  return (
    <div class="indicator group">
      <span
        class={`indicator-item badge badge-secondary badge-sm flex items-center bg-white text-[#29323A] mt-[-85px] mr-[175px] w-[14px] h-[14px] group-hover:bg-[#E9F408] ${
          totalItems === 0 ? "block" : ""
        }`}
      >
      ...
      <Button
        ...
        onClick={onClick}
      >
        <div class='flex items-center mr-[480px] mt-[5px] group '>
