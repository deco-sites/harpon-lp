  ...
  return (
    <>
      ...
      <div
        ...
        class="2xl:hidden xl:hidden lg:hidden md:hidden xs:-mt-[60px] 1xs:-mt-[60px] flex flex-row justify-between items-center border-b border-base-200 w-full pl-2 pr-6 gap-2"
      >
        <MenuButton />
        ...
        {logo && (
          <a
            href="/"
            class="flex-grow inline-flex items-center xs:hidden 1xs:absolute 1xs:mb-[150px] 1xs:hidden lg:hidden 2xl:hidden"
