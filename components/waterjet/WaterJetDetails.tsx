export default function WaterJetDetails() {
    return (
        <>
      ...
      <div class='ml-[783px] xs:ml-0 1xs:ml-0 md:ml-[100px] lg:ml-[672px]'>
        <h1 class='text-4xl text-[#29323A] font-bold xs:text-[28px] 1xs:text-3xl'>FLANGES</h1>
        <p class='text-sm text-[#29323A] md:w-max'>Flange para Escova 1/2" A-15/35 - PAR</p>
      </div>
      <div class='ml-[783px] xs:ml-0 xs:mt-[320px] 1xs:mt-[320px] 1xs:ml-0 md:ml-[100px] md:mt-[600px] lg:ml-[672px]'>
        <h2 class='text-[#29323A] text-base font-bold'>Descrição:</h2>
        <p class='text-sm text-[#29323A] mb-5 w-[490px] xs:w-[350px] 1xs:w-[350px] lg:w-auto'>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est .</p>
      ...
      <div class='border border-solid text-[#E6E6E6] w-[536px] h-[427px] absolute mt-[-350px] ml-[231px] xs:ml-0 xs:mt-[180px] xs:w-[350px] xs:h-[250px] 1xs:ml-0 1xs:mt-[180px] 1xs:w-[380px] 1xs:h-[250px] md:ml-[100px] lg:ml-[120px]'
      
      >
        <img class='mt-[90px] ml-[90px] xs:w-[270px] xs:ml-10 xs:mt-10 1xs:w-[270px] 1xs:ml-10 1xs:mt-10' src='flangeG.png'></img>
      </div>
      <div class='inline-grid gap-5 absolute mt-[-350px] ml-[139px] xs:inline-flex xs:w-[65px] xs:h-[65px] xs:mt-[450px] xs:ml-0 1xs:inline-flex 1xs:w-[65px] 1xs:h-[65px] 1xs:mt-[450px] 1xs:ml-0 md:inline-flex md:ml-[100px] md:mt-[710px] lg:ml-5'>
        <img class='w-[76px] md:w-[100px]' src='miniflange.png'></img>
        <img class='w-[76px] md:w-[100px]' src='miniflange2.png'></img>
        <img class='w-[76px] md:w-[100px]' src='miniflange3.png'></img>
        <img class='w-[76px] md:w-[100px]' src='miniflange4.png'></img>
      </div>
      <div class='mx-auto p-4 mt-[139px] mb-[100px] ml-[139px] xs:ml-0 xs:mt-5 1xs:ml-0 1xs:mt-5 md:ml-0 lg:ml-5'>
           ...
           <span style={{ fontWeight: 'bold' }}>PODE GOSTAR</span> 
            ...
            <div class='flex items-center group ml-[140px] xs:hidden 1xs:hidden md:hidden'>
                <p
