...
function Result({
  ...
  return (
    <>
      ...
      <div class='inline-flex items-center ml-[200px]'>
      ...
      />
      <div>
        <h1 class='text-[36px] font-normal ml-[139px] mt-[100px]'>TODOS OS {' '} 
           <span style={{ fontWeight: 'bold' }}>PRODUTOS</span>
        </h1>
        <div class='inline-flex'>
          <h2 class='text-[24px] font-bold ml-[139px] mt-[100px]'>
            CATEGORIAS
          </h2>
          <div class="inline-flex items-center ml-[130px] mt-[100px]">
          <svg class='mr-[-30px] z-10' xmlns="http://www.w3.org/2000/svg" width="16.419" height="16.423" viewBox="0 0 16.419 16.423">
            <path id="Icon_ionic-ios-search" data-name="Icon ionic-ios-search" d="M20.726,19.727,16.16,15.118a6.508,6.508,0,1,0-.988,1L19.709,20.7a.7.7,0,0,0,.992.026A.707.707,0,0,0,20.726,19.727Zm-9.68-3.553a5.139,5.139,0,1,1,3.634-1.505A5.107,5.107,0,0,1,11.046,16.174Z" transform="translate(-4.5 -4.493)" fill="#29323A"/>
             ...
             <input class="w-[444px] h-10 pl-[50px] text-left bg-[#F2F2F2] text-[#29323A] text-sm" type="search" id="MagnifyingGlass" placeholder="Faça uma busca" />
            <p class='font-bold text-[#29323A] ml-[120px]'>Ordenar por:</p>
            <select class='border border-solid bg-[#F2F2F2] w-[157px] h-10 ml-[5px] p-[2px] text-sm'>
        ...
        <div class='mt-[400px]'>
          <p class='text-normal font-bold mt-[-350px] ml-[139px]'>Recapagem</p>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Carbide</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Fresas com ponta</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Hastes</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2 bg-[#29323A]' type='checkbox'> Flanges</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Copos de corte</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Extrusoras</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Sovelas</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Escova Harpon</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Roletes</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Almofadas</input>
            </div>
            <hr class='ml-[139px] mt-[30px] w-[260px] text-[#C8C8CA] border'></hr>
            <div>
            <p class='text-normal font-bold mt-5 ml-[139px]'>Corte</p>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Abrasivos</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Orifício</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Tubo de mistura</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Acessórios e ferramentas</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Peças de reposição</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Hidrojato</input>
            </div>
            <div>
            <input class='ml-[139px] mt-2' type='checkbox'> Laser</input>
            </div>
        <div class="w-fit grid grid-cols-3 gap-[1.5rem] mt-[-580px] ml-[410px] mb-[100px]">
