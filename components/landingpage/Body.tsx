...
export default function ImagesProducts() {
    return (
      <>
      <BannerCarousel />
      <div className="flex relative gap-[20px] justify-center mb-[150px] mt-[142px] xs:w-auto xs:flex-col xs:mt-[100px] xs:ml-0 xs:mb-0 1xs:w-max 1xs:flex-col 1xs:mt-0 md:w-max 2xl:justify-center 2xl:mt-[200px]">
          ...
          <div className="image-container">
           ...
           {/*  <a class="xs:text-[10px] 1xs:text-sm md:text-sm" href="https://www.harpon.com.br/waterjet"> */}
              <p
                ...
                className="absolute z-10 mt-[-20px] ml-[200px] image-overlay font-bold text-[#29323A] bg-[#E9F408] xs:text-[18px] xs:ml-[140px] xs:-mt-5"
              >
                EM BREVE
              </p>
            {/* </a> */}
            <div className="absolute bottom-[190px]  left-[30px] text-[32px]  font-normal text-white xs:text-4xl xs:mb-0 xs:mt-5 xs:relative 1xs:text-xl ">
        ...
        <div className="relative group xs:w-auto 1xs:w-max lg:w-max">
          <div className="image-container">
            ...
            >
              <p
                style={{ border: "solid 1px white", padding: "8px" }}
                className="absolute z-10 mt-[-20px] ml-[200px] image-overlay font-bold text-[#29323A] bg-[#E9F408] xs:text-[18px] xs:ml-[120px]"
              >
                VISITE A LOJA
              </p>
            </a>
  
            <div className="absolute bottom-[190px] left-[30px] text-[32px] font-[Albert Sans] font-normal text-white xs:text-4xl xs:mb-0 xs:relative xs:mt-5 1xs:text-xl 1xs:mb-[-30px] md:mb-[-60px] lg:mb-[-20px]">
