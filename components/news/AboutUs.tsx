...
export default function AboutUs () {
    ...
    return (
        <>
      <div class="hidden  items-center w-full h-20 bg-[#29323A] xs:w-auto md:w-max">
        ...
        <div class="inline-flex items-center  ml-[40%] xs:ml-[270px] 1xs:ml-[280px] md:ml-[260px] lg:ml-[400px]">
      ...
      <div class="flex-auto flex  ml-[200px] gap-[10px] text-white font-bold sm:ml-[350px] md:mr-0 md:ml-[100px] lg:ml-[50px] lg:mr-[-120px]">
          <a href='/'>
      ...
      <div class='bg-[#E4E4E4] h-[543px] xs:h-[785px] 1xs:h-[785px] md:w-max md:h-[750px] lg:h-auto'>
        <div class='bg-[#E4E4E4] h-[50px]'></div>
        <div class='bg-[#E9F408] flex justify-center w-[150px] h-[50px] m-auto mt-5 md:w-[200px] md:my-5 md:mx-[300px] lg:w-[250px]'>
          <h1 class='flex items-center text-xl font-bold md:text-2xl lg:text-3xl'>Sobre Nós</h1>
        </div>
