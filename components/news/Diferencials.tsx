export default function Diferencials () {
    return (
        <div class='flex mt-[150px] xs:mt-0 1xs:mt-0'>
            ...
            <div class='w-[55%] bg-[#29323A] xs:w-max 1xs:w-full md:w-full'>
                <h1 class='text-white  text-4xl text-center font-[Albert Sans] mt-[50px] mr-[115px] xs:text-[20px] xs:whitespace-[nowrap] xs:px-[50px] 1xs:text-[26px] md:text-[30px] md:mr-2 lg:ml-10 lg:w-max'>NOSSOS{' '} 
                <span style={{ fontWeight: 'bold' }}>DIFERENCIAIS</span>
                </h1>
                <div class='w-[444px] h-[105px] mt-5 ml-[125px] mb-3 bg-[#3D4B58] xs:w-[280px] xs:h-[90px] xs:ml-[50px] 1xs:ml-10 1xs:w-[350px] md:w-[330px] md:ml-[30px] lg:ml-10'
