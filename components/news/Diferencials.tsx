export default function Diferencials () { /* Teste*/
    return (
        <div class='flex xl:justify-center mt-[150px] xs:mt-0 1xs:mt-0'> 
            ...
            <div class='w-[55%] bg-[#29323A] xs:w-max 1xs:w-full md:w-full'>
                ...
                <div class='w-[444px] h-[105px] mt-5 ml-[180px] mb-3 bg-[#3D4B58] xs:w-[280px] xs:h-[90px] xs:ml-[50px] 1xs:ml-10 1xs:w-[350px] md:w-[330px] md:ml-[30px] lg:ml-10'
