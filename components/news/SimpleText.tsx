export default function SimpleText() {
    return (
            ...
            <div class='flex mt-[150px] ml-[75px] mb-[100px] xs:w-auto xs:flex-col xs:mt-0 xs:mb-0  1xs:w-auto 1xs:flex-col 1xs:mt-0 1xs:ml-0 1xs:mb-0 sm:mt-0 sm:ml-0 md:ml-0 lg:mt-5 lg:mb-5 xl:mt-5 xl:mb-5 2xl:mt-5 2xl:mb-5'>
                <div class='w-[50%] p-4 2xl:ml-[75px]'>
                    <h1 class='text-3xl mt-12 font-[Albert Sans] w-[439px] xs:text-[20px] xs:mt-0 xs:w-[200px] 1xs:text-2xl 1xs:mt-0 sm:text-2xl '>NUNCA{' '} 
